...
export const createArticleValidator = [
  ...
  body("excerpt")
    ...
    .isLength({ max: 500 })
    .withMessage("El resumen no puede exceder los 500 caracteres.")
    .trim(),
...
export const updateArticleValidator = [
  ...
  body("excerpt")
    ...
    .withMessage("El resumen debe ser texto.")
    .isLength({ max: 500 })
    .withMessage("El resumen no puede exceder los 500 caracteres.") // Se usa el mismo límite que en create
    .trim(),
