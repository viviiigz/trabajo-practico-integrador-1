...
export const getUserArticleById = async (req, res) => {
  ...
  try {
    ...
    if (!article) {
      return res
        .status(404)
        .json({ message: "Artículo no encontrado para este usuario." });
    }
    return res.status(200).json(article);
  } catch (error) {
    console.error(error);
  ...
  try {
    ...
    if (!article) {
      return res
        .status(404)
        .json({
          message: "Artículo no encontrado o no autorizado para actualizar.",
        });
    }
  ...
  try {
    ...
    if (!article) {
      return res
        .status(404)
        .json({
          message: "Artículo no encontrado o no autorizado para eliminar.",
        });
    }
